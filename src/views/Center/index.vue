          ...
          <div class="order-content">
            ...
            <div class="orders">
              <table class="order-item">
                  ...
                  <tr>
                    <th colspan="5">
                      <span class="ordertitle"
                        >{{new Date()}}订单编号：7867473872181848
                ...
                <tbody>
                  <tr v-for="list in trade.detailArrayList" :key="list.skuId">
                    <td width="60%">
                      <div class="typographic">
                        <img style="width: 150px" :src="list.imgUrl" />
                    ...
                    <td rowspan="2" width="13%" class="center">
                      <ul class="unstyled">
                        <li>总金额¥{{ list.skuNum * list.orderPrice }}</li>
                        <li>在线支付</li>
                      </ul>
                    </td>
